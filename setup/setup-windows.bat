...
curl -# -L -O "https://github.com/CobaltBar/SScript-Archive/raw/refs/heads/main/archives/SScript-5,2,0.zip"
haxelib install "SScript-5,2,0.zip"
del "SScript-5,2,0.zip"
@echo off
