...
class PlayState extends MusicBeatState
{
	...
	function set_health(value:Float):Float // You can alter how icon animations work here
	{
		...
		switch (iconP1.numFrames) {
			case 1:
				iconP1.animation.curAnim.curFrame = 0; // If for some reason you have an icon thats only one fucking frame. (why would you?!)
