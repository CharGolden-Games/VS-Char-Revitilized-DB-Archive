...
typedef CharacterFile = {
	...
	var losingicon:String; 
	var winningicon:String;
...
class Character extends FlxSprite
{
	...
	public var losingIcon:String = ''; 
	public var winningIcon:String = '';
	...
	public static var DEFAULT_CHARACTER:String = 'char'; //In case a character is missing, it will use BF on its place
	public function new(x:Float, y:Float, ?character:String = 'char', ?isPlayer:Bool = false)
	{
		super(x, y);
		...
		switch (curCharacter)
		{
			...
			default:
				...
				normalIcon = json.normalicon;
				losingIcon = json.losingicon; 
