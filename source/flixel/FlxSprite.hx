...
class FlxSprite extends FlxObject
{
	...
	/**
	 * Where the sprite is on the Z Axis (Used for sorting.)
	 */
	public var zIndex:Int = 0;

	/**
	 * The generic name of the sprite. can be used for better specifying calls, but is just the path of the sprite by default
	 */
	...
	public function loadGraphic(graphic:FlxGraphicAsset, animated = false, frameWidth = 0, frameHeight = 0, unique = false, ?key:String):FlxSprite
	{
		...
		if (key != null) {
			...
			this.spriteName = this.graphic.key;
		}
		return this;
	}
	...
	public function makeGraphic(Width:Int, Height:Int, Color:FlxColor = FlxColor.WHITE, Unique:Bool = false, ?Key:String):FlxSprite
	{
		...
		frames = graph.imageFrame;
		this.spriteName = Std.string(Color) + '_ColorGen_Sprite';
		return this;
	}
