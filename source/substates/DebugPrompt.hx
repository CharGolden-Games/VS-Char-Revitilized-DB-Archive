...
class DebugPrompt extends MusicBeatSubstate
{
	...
	var buttons:FlxSprite = new FlxSprite(873.3, 750);
	var theText:String = '';
	...
	override public function create():Void 
	{
		...
		makeSelectorGraphic(panel, FlxG.width - 10,FlxG.height - 10,0x80ffa600);
		makeSelectorGraphic(panelbg,FlxG.width,FlxG.height,0x99573800);
		...
		add(buttonNo);
		//add(buttons);
		var textshit:FlxText = new FlxText(panel.width, panel.y, 300, theText, 70);
		textshit.setFormat("VCR OSD Mono", 70, FlxColor.BLACK, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.WHITE);
