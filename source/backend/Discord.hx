...
class DiscordClient
{
	...
	private inline static final _defaultID:String = "1274071752926036120";
	...
	public static function changePresence(details:String = 'In the Menus', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'icon')
	{
		...
		presence.details = details + ' | Psych 1.0 Pre-Release ver.';
		presence.smallImageKey = smallImageKey;
		presence.largeImageKey = largeImageKey;
		presence.largeImageText = "Char Engine Version: " + states.MainMenuState.charEngineVersion;
